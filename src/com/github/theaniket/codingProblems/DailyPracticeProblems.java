package com.github.theaniket.codingProblems;
...
public class DailyPracticeProblems {

    private static final InputStreamReader inputStream = new InputStreamReader(System.in);
    private static final BufferedReader bufferedReader = new BufferedReader(inputStream);
...
//    You should return 2, since bishops 1 and 3 attack each other, as well as bishops 3 and 4.
    public static void specialChessboard() throws IOException {
        int testCases = Integer.parseInt(bufferedReader.readLine());
        while (testCases>0){
            int boardSize = Integer.parseInt(bufferedReader.readLine());
            int[][] board = new int[boardSize][boardSize];
            int noOfPairs = Integer.parseInt(bufferedReader.readLine());
